...
const MARKETING_SCENARIO_MAP: Record<string, ScenarioId> = {
  "ai-essay-grader": "essay",
  "student-comments": "comment",
  "exam-generator": "exam",
  "teaching-reflection": "reflection",
...
export default function TeacherDeckPage() {
  ...
  useEffect(() => {
    ...
    if (requestedScenario && MARKETING_SCENARIO_MAP[requestedScenario]) {
      // URL 参数只在客户端恢复工作台入口场景。
      // eslint-disable-next-line react-hooks/set-state-in-effect
      setScenario(MARKETING_SCENARIO_MAP[requestedScenario]);
    }
